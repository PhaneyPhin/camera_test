...
function clickStartRealPlay(iStreamType) {
    ...
    var startRealPlay = function (iStreamType) {
        var data = {
            iRtspPort: iRtspPort,
        ...
        // {bZeroChannel: false, iChannelID: 2, iRtspPort: 554, iStreamType: 1}
        WebVideoCtrl.I_StartRealPlay(szDeviceIdentify, data);
    };
